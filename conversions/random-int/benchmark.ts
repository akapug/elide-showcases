/**
 * Performance Benchmark: random-int
 *
...
console.log("🏎️  random-int Performance Benchmark\n");
console.log("Testing Elide's polyglot random-int implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Random Number Generation (${ITERATIONS.toLocaleString()} iterations) ===\n`);
