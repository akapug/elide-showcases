/**
 * Java Integration Example for elide-natural-compare
 *
 * This demonstrates calling the TypeScript natural-compare implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One natural-compare implementation shared across TypeScript and Java
 * - Consistent natural sort order comparison for strings with numbers across all JVM services
...
public class ElideNaturalCompareExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript natural-compare ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value natural_compareModule = context.eval("js",
        //     "const module = require('./elide-natural-compare.ts'); module;");

        // Example: Basic usage
        // Value result = natural_compareModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses natural sort order comparison for strings with numbers");
        ...
        System.out.println("- Perfect for file listings, version sorting, human-friendly sorting");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide natural-compare (TypeScript)         │");
        System.out.println("│   conversions/natural-compare/elide-natural-compare.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same natural sort order comparison for strings with numbers everywhere!");
        System.out.println();
