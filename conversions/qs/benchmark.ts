...
console.log("🏎️  qs Performance Benchmark\n");
console.log("Testing Elide's polyglot qs implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Url Handling (${ITERATIONS.toLocaleString()} iterations) ===\n`);
