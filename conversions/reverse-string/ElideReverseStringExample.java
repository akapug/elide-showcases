/**
 * Java Integration Example for elide-reverse-string
 *
 * This demonstrates calling the TypeScript reverse-string implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One reverse-string implementation shared across TypeScript and Java
 * - Consistent reverse a string across all JVM services
...
public class ElideReverseStringExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript reverse-string ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value reverse_stringModule = context.eval("js",
        //     "const module = require('./elide-reverse-string.ts'); module;");

        // Example: Basic usage
        // Value result = reverse_stringModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses reverse a string");
        ...
        System.out.println("- Perfect for text manipulation, palindrome checking, data reversal");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide reverse-string (TypeScript)         │");
        System.out.println("│   conversions/reverse-string/elide-reverse-string.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same reverse a string everywhere!");
        System.out.println();
