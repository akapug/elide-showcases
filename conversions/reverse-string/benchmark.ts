/**
 * Performance Benchmark: reverse-string
 *
...
console.log("🏎️  reverse-string Performance Benchmark\n");
console.log("Testing Elide's polyglot reverse-string implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: String Reversal (${ITERATIONS.toLocaleString()} iterations) ===\n`);
