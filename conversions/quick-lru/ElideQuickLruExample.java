/**
 * Java Integration Example for elide-quick-lru
 *
 * This demonstrates calling the TypeScript quick-lru implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One quick-lru implementation shared across TypeScript and Java
 * - Consistent simple and fast lru cache implementation across all JVM services
...
public class ElideQuickLruExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript quick-lru ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value quick_lruModule = context.eval("js",
        //     "const module = require('./elide-quick-lru.ts'); module;");

        // Example: Basic usage
        // Value result = quick_lruModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses simple and fast lru cache implementation");
        ...
        System.out.println("- Perfect for API response caching, memoization, performance optimization");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide quick-lru (TypeScript)         │");
        System.out.println("│   conversions/quick-lru/elide-quick-lru.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same simple and fast lru cache implementation everywhere!");
        System.out.println();
