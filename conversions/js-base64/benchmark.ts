...
import { default as elideBase64 } from './elide-base64.ts';

console.log("🏎️  Base64 Benchmark\n");
console.log("Testing Elide's polyglot base64 encoding performance\n");
...
const batchResults = batchItems.map(item => elideBase64(item));
...
console.log(`  • Service processing 1M base64 encoding operations/day`);
