/**
 * Performance Benchmark: shallow-clone
 *
...
import pkg from './elide-shallow-clone.ts';

console.log("🏎️  shallow-clone Performance Benchmark\n");
console.log("Testing Elide's polyglot shallow-clone implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Object Cloning (${ITERATIONS.toLocaleString()} iterations) ===\n`);
