...
import { default as elideIni } from './elide-ini.ts';

console.log("🏎️  Ini Benchmark\n");
console.log("Testing Elide's polyglot INI parsing performance\n");
...
const batchResults = batchItems.map(item => elideIni(item));
...
console.log(`  • Service processing 1M INI parsing operations/day`);
...
console.log("=== Summary ===\n");
console.log("Elide Ini implementation:");
