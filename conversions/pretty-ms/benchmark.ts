/**
 * Performance Benchmark: pretty-ms
 *
...
console.log("🏎️  pretty-ms Performance Benchmark\n");
console.log("Testing Elide's polyglot pretty-ms implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Duration Formatting (${ITERATIONS.toLocaleString()} iterations) ===\n`);
