/**
 * Performance Benchmark: markdown-table
 *
...
console.log("🏎️  markdown-table Performance Benchmark\n");
console.log("Testing Elide's polyglot markdown-table implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Table Generation (${ITERATIONS.toLocaleString()} iterations) ===\n`);
