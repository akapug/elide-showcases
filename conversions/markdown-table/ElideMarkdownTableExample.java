/**
 * Java Integration Example for elide-markdown-table
 *
 * This demonstrates calling the TypeScript markdown-table implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One markdown-table implementation shared across TypeScript and Java
 * - Consistent generate markdown tables from data arrays across all JVM services
...
public class ElideMarkdownTableExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript markdown-table ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value markdown_tableModule = context.eval("js",
        //     "const module = require('./elide-markdown-table.ts'); module;");

        // Example: Basic usage
        // Value result = markdown_tableModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses generate markdown tables from data arrays");
        ...
        System.out.println("- Perfect for documentation generation, report formatting, data export");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide markdown-table (TypeScript)         │");
        System.out.println("│   conversions/markdown-table/elide-markdown-table.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same generate markdown tables from data arrays everywhere!");
        System.out.println();
