 ...
 * Asset Pipeline
 *
 * POLYGLOT SHOWCASE: One asset pipeline for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need asset pipeline
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share asset pipeline across your stack
 *
 * Package has ~50K+ downloads/week on npm!
 */

export class Broccoli {
...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  console.log("🌐 Same broccoli works in:");
  ...
  console.log("- One asset pipeline for all languages");
