/**
 * Informed - Flexible Form Library
 *
 * Lightweight informed form library
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/informed (~20K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Informed {
  return new Informed(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Informed - Flexible Form Library - Validation for Elide (POLYGLOT!)\n");
