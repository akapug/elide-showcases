 ...
 *
 * Based on https://www.npmjs.com/package/htmlparser2 (~10M+ downloads/week)
 *
 * Features:
...
// CLI Demo
if (import.meta.url.includes("elide-htmlparser2.ts")) {
  console.log("🌳 Htmlparser2 for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Htmlparser2 across languages:");
  console.log("  • JavaScript - Web scraping, HTML processing");
  ...
  console.log("- Web scraping, HTML processing");
