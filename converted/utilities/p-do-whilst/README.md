# P-do-whilst - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-p-do-whilst.ts';
...
```bash
elide run elide-p-do-whilst.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/p-do-whilst)
