 ...
 *
 * Based on https://www.npmjs.com/package/webcomponent (~5K+ downloads/week)
 *
 * Features:
...
if (import.meta.url.includes("elide-webcomponent.ts")) {
  console.log("🎨 webcomponent - Web Component Base for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same webcomponent components work in:");
