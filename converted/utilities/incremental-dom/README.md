...
Based on [npm:incremental-dom](https://www.npmjs.com/package/incremental-dom) (~100K+ downloads/week)
...
```typescript
import { defineComponent, html, css } from './elide-incremental-dom.ts';
