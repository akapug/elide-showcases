 ...
 * Marko
 *
 * HTML re-imagined as a language
 * **POLYGLOT SHOWCASE**: One template engine for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/marko (~1M downloads/week)
 *
 * Features:
...
// CLI Demo
if (import.meta.url.includes("elide-marko.ts")) {
  console.log("✅ Marko (POLYGLOT!)\n");
