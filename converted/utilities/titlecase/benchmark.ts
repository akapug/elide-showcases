/**
 * Performance Benchmark: titlecase
 *
...
console.log("🏎️  titlecase Performance Benchmark\n");
console.log("Testing Elide's polyglot titlecase implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Text Formatting (${ITERATIONS.toLocaleString()} iterations) ===\n`);
