...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔄 Axios retry - HTTP Retry (POLYGLOT!)\n");
  ...
  setTimeout(() => {
    ...
    console.log("🌐 Same axios-retry works in:");
