 ...
 * Recurring Schedules
 *
 * POLYGLOT SHOWCASE: One recurring schedules for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need recurring schedules
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share recurring schedules across your stack
 *
...
const instance = new Later();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Recurring Schedules for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same later works in:");
  ...
  console.log("- One recurring schedules for all languages");
