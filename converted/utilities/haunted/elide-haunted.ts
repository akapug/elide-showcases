 ...
 *
 * Based on https://www.npmjs.com/package/haunted (~20K+ downloads/week)
 *
 * Features:
...
if (import.meta.url.includes("elide-haunted.ts")) {
  console.log("🎨 haunted - Hooks for Web Components for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same haunted components work in:");
