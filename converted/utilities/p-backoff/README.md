# P-backoff - Elide Polyglot Showcase
...
```typescript
import { Backoff, backoff } from './elide-p-backoff.ts';
...
```bash
elide run elide-p-backoff.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/p-backoff)
