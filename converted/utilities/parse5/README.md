# Parse5 - HTML Parser - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

WHATWG HTML5 specification-compliant parser with a single implementation that works across your entire polyglot stack.
...
- ✅ WHATWG HTML5 specification-compliant parser
...
```typescript
import { parse, generate, traverse } from './elide-parse5.ts';
...
parser = require('./elide-parse5.ts')
...
```ruby
parser = Elide.require('./elide-parse5.ts')
...
Value parser = context.eval("js", "require('./elide-parse5.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide Parse5 - HTML Parser (TypeScript)      │
│     elide-parse5.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Server-side rendering, HTML analysis
...
- [npm package](https://www.npmjs.com/package/parse5)
