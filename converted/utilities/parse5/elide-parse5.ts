 ...
 * Parse5
 *
 * HTML parser compliant with spec
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/parse5 (~5M+ downloads/week)
 *
 * Features:
 * - WHATWG HTML5 spec-compliant parser
 ...
 *
 * Use cases:
 * - Server-side rendering, HTML analysis
...
// CLI Demo
if (import.meta.url.includes("elide-parse5.ts")) {
  console.log("🌳 Parse5 for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Parse5 across languages:");
  console.log("  • JavaScript - Server-side rendering, HTML analysis");
  ...
  console.log("- Server-side rendering, HTML analysis");
