 ...
 *
 * Based on https://www.npmjs.com/package/escope (~5M+ downloads/week)
 *
 * Features:
 * - Standard scope analysis library
 ...
 *
 * Use cases:
 * - Linters, compilers, optimization tools
...
// CLI Demo
if (import.meta.url.includes("elide-escope.ts")) {
  console.log("🌳 Escope for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Escope across languages:");
  console.log("  • JavaScript - Linters, compilers, optimization tools");
  ...
  console.log("- Linters, compilers, optimization tools");
