/**
 * Java Integration Example for elide-semver
 *
 * This demonstrates calling the TypeScript semver implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One semver implementation shared across TypeScript and Java
 * - Consistent parse and compare semantic version numbers across all JVM services
...
public class ElideSemverExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript semver ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value semverModule = context.eval("js",
        //     "const module = require('./elide-semver.ts'); module;");

        // Example: Basic usage
        // Value result = semverModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses parse and compare semantic version numbers");
        ...
        System.out.println("- Perfect for version management, dependency resolution, release automation");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide semver (TypeScript)         │");
        System.out.println("│   conversions/semver/elide-semver.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same parse and compare semantic version numbers everywhere!");
        System.out.println();
