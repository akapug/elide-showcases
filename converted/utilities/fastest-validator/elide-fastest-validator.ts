 ...
 * Fastest Validator
 *
 * Blazingly fast validator
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/fastest-validator (~100K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): FastestValidator {
  return new FastestValidator(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Fastest Validator - Validation for Elide (POLYGLOT!)\n");
