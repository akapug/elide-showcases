/**
 * nanohtml - Tiny HTML Templates
 *
 * Tiny HTML Templates
 * **POLYGLOT SHOWCASE**: One nanohtml implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/nanohtml (~20K+ downloads/week)
 *
 * Features:
 * - Tiny template string helper
...
if (import.meta.url.includes("elide-nanohtml.ts")) {
  console.log("🎨 nanohtml - Tiny HTML Templates for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same nanohtml components work in:");
