 ...
 *
 * Based on https://www.npmjs.com/package/valibot (~50K+ downloads/week)
 *
 * Features:
 * - Schema-based validation
 * - Custom validators
...
export function createValidator(schema: ValidationSchema): Valibot {
  return new Valibot(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Valibot - Validation Library - Validation for Elide (POLYGLOT!)\n");
