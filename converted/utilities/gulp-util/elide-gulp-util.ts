 ...
 * Gulp Utilities
 *
 * POLYGLOT SHOWCASE: One gulp utilities for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need gulp utilities
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share gulp utilities across your stack
 *
 * Package has ~200K+ downloads/week on npm!
 */

export class GulpUtil {
...
const instance = new GulpUtil();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Gulp Utilities for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same gulp-util works in:");
  ...
  console.log("- One gulp utilities for all languages");
