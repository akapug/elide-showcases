/**
 * Performance Benchmark: swap-case
 *
...
console.log("🏎️  swap-case Performance Benchmark\n");
console.log("Testing Elide's polyglot swap-case implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Case Transformation (${ITERATIONS.toLocaleString()} iterations) ===\n`);
