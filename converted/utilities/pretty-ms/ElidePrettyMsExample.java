/**
 * Java Integration Example for elide-pretty-ms
 *
 * This demonstrates calling the TypeScript pretty-ms implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One pretty-ms implementation shared across TypeScript and Java
 * - Consistent convert milliseconds to human-readable strings across all JVM services
...
public class ElidePrettyMsExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript pretty-ms ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value pretty_msModule = context.eval("js",
        //     "const module = require('./elide-pretty-ms.ts'); module;");

        // Example: Basic usage
        // Value result = pretty_msModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses convert milliseconds to human-readable strings");
        ...
        System.out.println("- Perfect for performance metrics, duration formatting, UI display");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide pretty-ms (TypeScript)         │");
        System.out.println("│   conversions/pretty-ms/elide-pretty-ms.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same convert milliseconds to human-readable strings everywhere!");
        System.out.println();
