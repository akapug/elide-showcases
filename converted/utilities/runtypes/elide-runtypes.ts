...
export function createValidator(schema: ValidationSchema): Runtypes {
  return new Runtypes(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Runtypes - Runtime Validation - Validation for Elide (POLYGLOT!)\n");
