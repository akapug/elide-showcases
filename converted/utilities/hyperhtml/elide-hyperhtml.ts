/**
 * hyperhtml - Fast HTML Templates
 *
 * Fast HTML Templates
 * **POLYGLOT SHOWCASE**: One hyperhtml implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/hyperhtml (~30K+ downloads/week)
 *
 * Features:
 * - Streaming HTML template engine
 ...
 *
 * Package has ~30K+ downloads/week on npm - essential web component tool!
 */
...
if (import.meta.url.includes("elide-hyperhtml.ts")) {
  console.log("🎨 hyperhtml - Fast HTML Templates for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same hyperhtml components work in:");
