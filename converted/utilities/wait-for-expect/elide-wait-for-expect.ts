 ...
 * Async Waiting
 *
 * POLYGLOT SHOWCASE: One async waiting for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need async waiting
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share async waiting across your stack
 *
 * Package has ~100K+ downloads/week on npm!
 */

export class WaitForExpect {
...
const instance = new WaitForExpect();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Async Waiting for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same wait-for-expect works in:");
  ...
  console.log("- One async waiting for all languages");
