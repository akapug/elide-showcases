 ...
 *
 * Based on https://www.npmjs.com/package/constraint-validator (~5K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): ConstraintValidator {
  return new ConstraintValidator(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Constraint Validator - Validation for Elide (POLYGLOT!)\n");
