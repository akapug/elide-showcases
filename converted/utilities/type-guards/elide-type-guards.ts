 ...
 *
 * Based on https://www.npmjs.com/package/type-guards (~50K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): TypeGuards {
  return new TypeGuards(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Type Guards - Runtime Checks - Validation for Elide (POLYGLOT!)\n");
