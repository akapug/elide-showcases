 ...
 *
 * Component Framework
 * **POLYGLOT SHOWCASE**: One component implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/component (~50K+ downloads/week)
 *
 * Features:
 * - Client-side component builder
...
if (import.meta.url.includes("elide-component.ts")) {
  console.log("🎨 component - Component Framework for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same component components work in:");
