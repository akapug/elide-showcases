 ...
 * **POLYGLOT SHOWCASE**: One less for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/less (~10M+ downloads/week)
 *
 * Features:
 ...
 * - ONE less works everywhere on Elide
...
// CLI Demo
if (import.meta.url.includes("elide-less.ts")) {
  ...
  console.log("🌐 Same less logic works in:");
  ...
  console.log("  ✓ One less, all languages");
