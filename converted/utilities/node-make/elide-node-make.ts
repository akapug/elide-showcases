 ...
 * Makefile Runner
 *
 * POLYGLOT SHOWCASE: One makefile runner for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need makefile runner
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share makefile runner across your stack
 *
 * Package has ~5K+ downloads/week on npm!
 */

export class NodeMake {
...
const instance = new NodeMake();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Makefile Runner for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same node-make works in:");
  ...
  console.log("- One makefile runner for all languages");
