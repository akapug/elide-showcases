...
Based on [npm:custom-elements](https://www.npmjs.com/package/custom-elements) (~100K+ downloads/week)
...
```typescript
import { defineComponent, html, css } from './elide-custom-elements.ts';
