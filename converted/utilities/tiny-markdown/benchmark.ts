/**
 * Performance Benchmark: tiny-markdown
 *
...
import pkg from './elide-tiny-markdown.ts';

console.log("🏎️  tiny-markdown Performance Benchmark\n");
console.log("Testing Elide's polyglot tiny-markdown implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Markdown Parsing (${ITERATIONS.toLocaleString()} iterations) ===\n`);
