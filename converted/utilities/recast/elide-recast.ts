 ...
 * Recast
 *
 * JavaScript AST transformation preserving formatting
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/recast (~1M+ downloads/week)
 *
 * Features:
 * - Non-destructive code transformation
 ...
 *
 * Use cases:
 * - Refactoring tools, codemods that preserve style
...
// CLI Demo
if (import.meta.url.includes("elide-recast.ts")) {
  console.log("🌳 Recast for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Recast across languages:");
  console.log("  • JavaScript - Refactoring tools, codemods that preserve style");
  ...
  console.log("- Refactoring tools, codemods that preserve style");
