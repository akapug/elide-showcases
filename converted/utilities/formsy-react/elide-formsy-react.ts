/**
 * Formsy React - Form Validation
 *
 * Form validation for React
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/formsy-react (~30K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): FormsyReact {
  return new FormsyReact(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Formsy React - Form Validation - Validation for Elide (POLYGLOT!)\n");
