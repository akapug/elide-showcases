# Meriyah - JavaScript Parser - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Fast and spec-compliant ES2023 parser with JSX with a single implementation that works across your entire polyglot stack.
...
- ✅ Fast and spec-compliant ES2023 parser with JSX
...
```typescript
import { parse, generate, traverse } from './elide-meriyah.ts';
...
parser = require('./elide-meriyah.ts')
...
```ruby
parser = Elide.require('./elide-meriyah.ts')
...
Value parser = context.eval("js", "require('./elide-meriyah.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide Meriyah - JavaScript Parser (TypeScript)      │
│     elide-meriyah.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Modern JS parsing, JSX/TypeScript support
...
- [npm package](https://www.npmjs.com/package/meriyah)
