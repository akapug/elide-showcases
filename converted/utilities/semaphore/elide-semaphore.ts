 ...
 * Semaphore
 *
 * POLYGLOT SHOWCASE: One semaphore for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need semaphore
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share semaphore across your stack
 *
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🚦 Semaphore for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same semaphore works in:");
  ...
  console.log("- One semaphore for all languages");
