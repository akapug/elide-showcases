 ...
 *
 * Based on https://www.npmjs.com/package/typebox (~200K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Typebox {
  return new Typebox(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ TypeBox - JSON Schema Builder - Validation for Elide (POLYGLOT!)\n");
