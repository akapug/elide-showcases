 ...
 *
 * Based on https://www.npmjs.com/package/parsley (~50K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Parsley {
  return new Parsley(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Parsley - Form Validator - Validation for Elide (POLYGLOT!)\n");
