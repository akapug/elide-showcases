# quick-lru - Elide Polyglot Showcase

> **One quick-lru implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Fast lru cache with a single implementation that works across your entire polyglot stack.
...
pkg = require('./elide-quick-lru.ts')
...
```ruby
pkg = Elide.require('./elide-quick-lru.ts')
...
Value pkgModule = context.eval("js", "require('./elide-quick-lru.ts')");
...
Perfect for API responses, computation results, performance optimization.
...
**Result**: All services handle caching identically, guaranteed.

## 📂 Files in This Showcase

- `elide-quick-lru.ts` - Main TypeScript implementation
- `elide-quick-lru.py` - Python integration example
- `elide-quick-lru.rb` - Ruby integration example
- `ElideQuicklruExample.java` - Java integration example
...
```bash
# Python
elide run elide-quick-lru.py

# Ruby
elide run elide-quick-lru.rb

# Java
elide run ElideQuicklruExample.java
```
...
- [npm quick-lru package](https://www.npmjs.com/package/quick-lru)
- [GitHub: elide-showcases](https://github.com/akapug/elide-showcases)

## 📝 Package Stats

- **npm downloads**: 1M+/week
- **Use case**: Api responses, computation results, performance optimization
