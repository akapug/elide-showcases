/**
 * atomico - Micro Web Components
 *
 * Micro Web Components
 * **POLYGLOT SHOWCASE**: One atomico implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/atomico (~5K+ downloads/week)
 *
 * Features:
 * - Tiny library for web components
...
if (import.meta.url.includes("elide-atomico.ts")) {
  console.log("🎨 atomico - Micro Web Components for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same atomico components work in:");
