...
Based on [npm:document-register-element](https://www.npmjs.com/package/document-register-element) (~50K+ downloads/week)
...
```typescript
import { defineComponent, html, css } from './elide-document-register-element.ts';
