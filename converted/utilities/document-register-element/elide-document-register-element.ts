/**
 * document-register-element - Custom Elements v1
 *
 * Custom Elements v1
 * **POLYGLOT SHOWCASE**: One document-register-element implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/document-register-element (~50K+ downloads/week)
 *
 * Features:
 * - Lightweight custom elements polyfill
...
if (import.meta.url.includes("elide-document-register-element.ts")) {
  console.log("🎨 document-register-element - Custom Elements v1 for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same document-register-element components work in:");
