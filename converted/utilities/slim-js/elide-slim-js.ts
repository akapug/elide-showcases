 ...
 *
 * Based on https://www.npmjs.com/package/slim-js (~5K+ downloads/week)
 *
 * Features:
...
if (import.meta.url.includes("elide-slim-js.ts")) {
  console.log("🎨 slim-js - Lightweight Components for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same slim-js components work in:");
