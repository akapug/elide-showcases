/**
 * Performance Benchmark: word-wrap
 *
...
console.log("🏎️  word-wrap Performance Benchmark\n");
console.log("Testing Elide's polyglot word-wrap implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Text Wrapping (${ITERATIONS.toLocaleString()} iterations) ===\n`);
