 ...
 *
 * Based on https://www.npmjs.com/package/x-tag (~10K+ downloads/week)
 *
 * Features:
...
if (import.meta.url.includes("elide-x-tag.ts")) {
  console.log("🎨 x-tag - Custom Elements Utility for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same x-tag components work in:");
