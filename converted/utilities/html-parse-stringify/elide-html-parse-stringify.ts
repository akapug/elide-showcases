 ...
 *
 * Simple HTML parser and stringifier
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/html-parse-stringify (~100K+ downloads/week)
 *
 * Features:
...
// CLI Demo
if (import.meta.url.includes("elide-html-parse-stringify.ts")) {
  console.log("🌳 Html Parse Stringify for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Html Parse Stringify across languages:");
  console.log("  • JavaScript - Simple HTML manipulation");
  ...
  console.log("- Simple HTML manipulation");
