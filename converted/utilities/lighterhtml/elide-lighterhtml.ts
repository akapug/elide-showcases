/**
 * lighterhtml - Lighter HTML
 *
 * Lighter HTML
 * **POLYGLOT SHOWCASE**: One lighterhtml implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/lighterhtml (~5K+ downloads/week)
 *
 * Features:
 * - Light and fast HTML renderer
...
if (import.meta.url.includes("elide-lighterhtml.ts")) {
  console.log("🎨 lighterhtml - Lighter HTML for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same lighterhtml components work in:");
