 ...
 *
 * Based on https://www.npmjs.com/package/magic-string (~2M+ downloads/week)
 *
 * Features:
 * - Efficient string editing with sourcemaps
 ...
 *
 * Use cases:
 * - Bundlers, code transformation with maps
...
// CLI Demo
if (import.meta.url.includes("elide-magic-string.ts")) {
  console.log("🌳 Magic String for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Magic String across languages:");
  console.log("  • JavaScript - Bundlers, code transformation with maps");
  ...
  console.log("- Bundlers, code transformation with maps");
