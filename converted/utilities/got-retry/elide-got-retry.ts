...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔄 Got retry - HTTP Retry (POLYGLOT!)\n");
  ...
  setTimeout(() => {
    ...
    console.log("🌐 Same got-retry works in:");
