 ...
 * Read-Write Lock
 *
 * POLYGLOT SHOWCASE: One read-write lock for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need read-write lock
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share read-write lock across your stack
 *
...
const instance = new Rwlock();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Read-Write Lock for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same rwlock works in:");
  ...
  console.log("- One read-write lock for all languages");
