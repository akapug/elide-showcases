/**
 * counterpart - Internationalization Library
 * Based on https://www.npmjs.com/package/counterpart (~20K+ downloads/week)
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🌍 counterpart - i18n Library for Elide (POLYGLOT!)\n");
