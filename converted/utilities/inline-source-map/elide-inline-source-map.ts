 ...
 *
 * Based on https://www.npmjs.com/package/inline-source-map (~50K+ downloads/week)
 *
 * Features:
 * - Embed source maps in bundles
...
// CLI Demo
if (import.meta.url.includes("elide-inline-source-map.ts")) {
  console.log("🌳 Inline Source Map for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Inline Source Map across languages:");
  console.log("  • JavaScript - Development builds, debugging");
  ...
  console.log("- Development builds, debugging");
