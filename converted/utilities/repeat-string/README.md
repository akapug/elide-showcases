# repeat-string - Elide Polyglot Showcase

> **One repeat-string implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Repeat string n times with a single implementation that works across your entire polyglot stack.
...
pkg = require('./elide-repeat-string.ts')
...
```ruby
pkg = Elide.require('./elide-repeat-string.ts')
...
Value pkgModule = context.eval("js", "require('./elide-repeat-string.ts')");
...
Perfect for formatting, padding, ASCII art, templates.
...
**Result**: All services handle string manipulation identically, guaranteed.

## 📂 Files in This Showcase

- `elide-repeat-string.ts` - Main TypeScript implementation
- `elide-repeat-string.py` - Python integration example
- `elide-repeat-string.rb` - Ruby integration example
- `ElideRepeatstringExample.java` - Java integration example
...
```bash
elide run elide-repeat-string.ts
```
...
```bash
# Python
elide run elide-repeat-string.py

# Ruby
elide run elide-repeat-string.rb

# Java
elide run ElideRepeatstringExample.java
```
...
- [npm repeat-string package](https://www.npmjs.com/package/repeat-string)
- [GitHub: elide-showcases](https://github.com/akapug/elide-showcases)

## 📝 Package Stats

- **npm downloads**: 5M+/week
- **Use case**: Formatting, padding, ascii art, templates
