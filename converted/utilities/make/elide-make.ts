 ...
 * Make for Node
 *
 * POLYGLOT SHOWCASE: One make for node for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need make for node
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share make for node across your stack
 *
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Make for Node for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same make works in:");
  ...
  console.log("- One make for node for all languages");
