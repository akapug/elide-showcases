 ...
 *
 * Based on https://www.npmjs.com/package/bouncer (~5K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Bouncer {
  return new Bouncer(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Bouncer - Form Validation - Validation for Elide (POLYGLOT!)\n");
