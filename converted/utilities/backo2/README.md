# Backo2 - Elide Polyglot Showcase
...
```typescript
import { Backoff, backoff } from './elide-backo2.ts';
...
```bash
elide run elide-backo2.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/backo2)
