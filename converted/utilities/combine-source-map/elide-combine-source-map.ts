 ...
 *
 * Based on https://www.npmjs.com/package/combine-source-map (~100K+ downloads/week)
 *
 * Features:
 * - Merge source maps from pipeline
 ...
 *
 * Use cases:
 * - Multi-stage compilation, bundlers
...
// CLI Demo
if (import.meta.url.includes("elide-combine-source-map.ts")) {
  console.log("🌳 Combine Source Map for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Combine Source Map across languages:");
  console.log("  • JavaScript - Multi-stage compilation, bundlers");
  ...
  console.log("- Multi-stage compilation, bundlers");
