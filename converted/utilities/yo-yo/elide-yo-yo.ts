/**
 * yo-yo - Fast Template Strings
 *
 * Fast Template Strings
 * **POLYGLOT SHOWCASE**: One yo-yo implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/yo-yo (~10K+ downloads/week)
 *
 * Features:
 * - Fast template string library
 ...
 *
 * Package has ~10K+ downloads/week on npm - essential web component tool!
 */
...
if (import.meta.url.includes("elide-yo-yo.ts")) {
  console.log("🎨 yo-yo - Fast Template Strings for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same yo-yo components work in:");
