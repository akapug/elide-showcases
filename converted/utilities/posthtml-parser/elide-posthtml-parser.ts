 ...
 *
 * Based on https://www.npmjs.com/package/posthtml-parser (~400K+ downloads/week)
 *
 * Features:
 * - Parse HTML into PostHTML tree
...
// CLI Demo
if (import.meta.url.includes("elide-posthtml-parser.ts")) {
  console.log("🌳 Posthtml Parser for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Posthtml Parser across languages:");
  console.log("  • JavaScript - PostHTML plugin development");
  ...
  console.log("- PostHTML plugin development");
