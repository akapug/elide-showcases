...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-until.ts';
...
```bash
elide run elide-until.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/until)
