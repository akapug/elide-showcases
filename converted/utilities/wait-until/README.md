# Wait-until - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-wait-until.ts';
...
```bash
elide run elide-wait-until.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/wait-until)
