 ...
 * Class Transformer
 *
 * Transform objects with decorators
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/class-transformer (~2M+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): ClassTransformer {
  return new ClassTransformer(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Class Transformer - Validation for Elide (POLYGLOT!)\n");
