# P-times - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-p-times.ts';
...
```bash
elide run elide-p-times.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/p-times)
