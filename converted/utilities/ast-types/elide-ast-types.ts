 ...
 *
 * Based on https://www.npmjs.com/package/ast-types (~2M+ downloads/week)
 *
 * Features:
 ...
 *
 * Use cases:
 * - TypeScript AST tooling, type-safe transforms
...
// CLI Demo
if (import.meta.url.includes("elide-ast-types.ts")) {
  console.log("🌳 Ast Types for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Ast Types across languages:");
  console.log("  • JavaScript - TypeScript AST tooling, type-safe transforms");
  ...
  console.log("- TypeScript AST tooling, type-safe transforms");
