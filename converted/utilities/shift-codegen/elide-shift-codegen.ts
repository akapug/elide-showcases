 ...
 *
 * Based on https://www.npmjs.com/package/shift-codegen (~30K+ downloads/week)
 *
 * Features:
 * - Generate code from Shift AST
 ...
 *
 * Use cases:
 * - AST-to-code transformation, compiler backends
...
// CLI Demo
if (import.meta.url.includes("elide-shift-codegen.ts")) {
  console.log("🌳 Shift Codegen for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Shift Codegen across languages:");
  console.log("  • JavaScript - AST-to-code transformation, compiler backends");
  ...
  console.log("- AST-to-code transformation, compiler backends");
