 ...
 *
 * Based on https://www.npmjs.com/package/himalaya (~20K+ downloads/week)
 *
 * Features:
 * - Convert HTML to JSON AST
 ...
 *
 * Use cases:
 * - HTML analysis, template processing
...
// CLI Demo
if (import.meta.url.includes("elide-himalaya.ts")) {
  console.log("🌳 Himalaya for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Himalaya across languages:");
  console.log("  • JavaScript - HTML analysis, template processing");
  ...
  console.log("- HTML analysis, template processing");
