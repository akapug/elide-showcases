/**
 * Performance Benchmark: tinyqueue
 *
...
console.log("🏎️  tinyqueue Performance Benchmark\n");
console.log("Testing Elide's polyglot tinyqueue implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Priority Queue (${ITERATIONS.toLocaleString()} iterations) ===\n`);
