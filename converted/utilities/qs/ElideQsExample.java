/**
 * Java Integration Example for elide-qs
 *
 * This demonstrates calling the TypeScript qs implementation from Java
 * using Elide's polyglot capabilities via GraalVM.
 *
 * Benefits:
 * - One qs implementation shared across TypeScript and Java
 * - Consistent parse and stringify url query strings across all JVM services
...
public class ElideQsExample {
    public static void main(String[] args) {
        System.out.println("=== Java Calling TypeScript qs ===\n");

        // Example: Load TypeScript module via GraalVM
        // Context context = Context.newBuilder("js")
        //     .allowAllAccess(true)
        //     .build();
        // Value qsModule = context.eval("js",
        //     "const module = require('./elide-qs.ts'); module;");

        // Example: Basic usage
        // Value result = qsModule.getMember("default").execute();
        // System.out.println("Result: " + result);

        System.out.println("Real-world use case:");
        System.out.println("- Java service uses parse and stringify url query strings");
        ...
        System.out.println("- Perfect for API query parameters, URL generation, form data parsing");
        System.out.println();

        System.out.println("Example: Microservices Platform");
        System.out.println("┌─────────────────────────────────────┐");
        System.out.println("│   Elide qs (TypeScript)         │");
        System.out.println("│   conversions/qs/elide-qs.ts│");
        System.out.println("└─────────────────────────────────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    ┌────────┐  ┌────────┐  ┌────────┐");
        ...
        System.out.println("    └────────┘  └────────┘  └────────┘");
        System.out.println("         ↓           ↓           ↓");
        System.out.println("    Same parse and stringify url query strings everywhere!");
        System.out.println();
