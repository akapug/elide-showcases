 ...
 * **POLYGLOT SHOWCASE**: One omi implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/omi (~10K+ downloads/week)
 *
 * Features:
...
if (import.meta.url.includes("elide-omi.ts")) {
  console.log("🎨 omi - Web Components Framework for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same omi components work in:");
