# P-whilst - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-p-whilst.ts';
...
```bash
elide run elide-p-whilst.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/p-whilst)
