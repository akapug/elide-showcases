# CSSOM - CSS Object Model - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Complete CSS Object Model implementation with a single implementation that works across your entire polyglot stack.
...
- ✅ Complete CSS Object Model implementation
...
```typescript
import { parse, generate, traverse } from './elide-cssom.ts';
...
```ruby
parser = Elide.require('./elide-cssom.ts')
...
Value parser = context.eval("js", "require('./elide-cssom.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide CSSOM - CSS Object Model (TypeScript)      │
│     elide-cssom.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Dynamic CSS generation, CSSOM APIs
...
- [npm package](https://www.npmjs.com/package/cssom)
