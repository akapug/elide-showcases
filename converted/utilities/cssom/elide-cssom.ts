 ...
 *
 * Based on https://www.npmjs.com/package/cssom (~2M+ downloads/week)
 *
 * Features:
 ...
 *
 * Use cases:
 * - Dynamic CSS generation, CSSOM APIs
...
// CLI Demo
if (import.meta.url.includes("elide-cssom.ts")) {
  console.log("🌳 Cssom for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Cssom across languages:");
  console.log("  • JavaScript - Dynamic CSS generation, CSSOM APIs");
  ...
  console.log("- Dynamic CSS generation, CSSOM APIs");
