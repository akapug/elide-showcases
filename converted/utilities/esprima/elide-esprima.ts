 ...
 * Esprima
 *
 * ECMAScript parsing toolkit (ES2023 compliant)
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/esprima (~5M+ downloads/week)
 *
 * Features:
 * - JavaScript parser used by many tools
 ...
 *
 * Use cases:
 * - Parse JS code, syntax validation, token extraction
...
// CLI Demo
if (import.meta.url.includes("elide-esprima.ts")) {
  console.log("🌳 Esprima for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Esprima across languages:");
  console.log("  • JavaScript - Parse JS code, syntax validation, token extraction");
  ...
  console.log("- Parse JS code, syntax validation, token extraction");
