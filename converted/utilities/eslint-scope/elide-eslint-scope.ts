 ...
 * Eslint Scope
 *
 * Scope analysis for ESLint
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/eslint-scope (~10M+ downloads/week)
 *
 * Features:
 * - ESLint's fork of escope
 ...
 *
 * Use cases:
 * - ESLint plugins, custom lint rules
...
// CLI Demo
if (import.meta.url.includes("elide-eslint-scope.ts")) {
  console.log("🌳 Eslint Scope for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Eslint Scope across languages:");
  console.log("  • JavaScript - ESLint plugins, custom lint rules");
  ...
  console.log("- ESLint plugins, custom lint rules");
