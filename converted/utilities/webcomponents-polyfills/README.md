...
Based on [npm:webcomponents-polyfills](https://www.npmjs.com/package/webcomponents-polyfills) (~50K+ downloads/week)
...
```typescript
import { defineComponent, html, css } from './elide-webcomponents-polyfills.ts';
