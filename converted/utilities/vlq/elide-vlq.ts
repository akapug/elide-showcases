 ...
 *
 * Based on https://www.npmjs.com/package/vlq (~500K+ downloads/week)
 *
 * Features:
 ...
 *
 * Use cases:
 * - Source map generation, compression
...
// CLI Demo
if (import.meta.url.includes("elide-vlq.ts")) {
  console.log("🌳 Vlq for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Vlq across languages:");
  console.log("  • JavaScript - Source map generation, compression");
  ...
  console.log("- Source map generation, compression");
