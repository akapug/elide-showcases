 ...
 * Sleep Function
 *
 * POLYGLOT SHOWCASE: One sleep function for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need sleep function
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share sleep function across your stack
 *
...
const instance = new SleepPromise();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Sleep Function for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same sleep-promise works in:");
  ...
  console.log("- One sleep function for all languages");
