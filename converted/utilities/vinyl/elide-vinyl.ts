 ...
 * Virtual File Format
 *
 * POLYGLOT SHOWCASE: One virtual file format for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need virtual file format
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share virtual file format across your stack
 *
...
const instance = new Vinyl();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Virtual File Format for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same vinyl works in:");
  ...
  console.log("- One virtual file format for all languages");
