# Walk - Simple AST Walker - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Minimal and simple AST walking utility with a single implementation that works across your entire polyglot stack.
...
- ✅ Minimal and simple AST walking utility
...
```typescript
import { parse, generate, traverse } from './elide-walk.ts';
...
```ruby
parser = Elide.require('./elide-walk.ts')
...
Value parser = context.eval("js", "require('./elide-walk.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide Walk - Simple AST Walker (TypeScript)      │
│     elide-walk.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Educational projects, simple code transformations
...
- [npm package](https://www.npmjs.com/package/walk)
