 ...
 *
 * Based on https://www.npmjs.com/package/esrecurse (~10M+ downloads/week)
 *
 * Features:
 ...
 *
 * Use cases:
 * - Deep analysis, recursive transformations
...
// CLI Demo
if (import.meta.url.includes("elide-esrecurse.ts")) {
  console.log("🌳 Esrecurse for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Esrecurse across languages:");
  console.log("  • JavaScript - Deep analysis, recursive transformations");
  ...
  console.log("- Deep analysis, recursive transformations");
