 ...
 * CSS Preprocessor
 *
 * CSS preprocessor with power.
 * **POLYGLOT SHOWCASE**: One sass for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/sass (~12M+ downloads/week)
 *
 * Features:
 ...
 * - ONE sass works everywhere on Elide
 ...
 *
 * Package has ~12M+ downloads/week on npm - essential build tool!
 */
...
// CLI Demo
if (import.meta.url.includes("elide-sass.ts")) {
  ...
  console.log("🌐 Same sass logic works in:");
  ...
  console.log("  ✓ One sass, all languages");
