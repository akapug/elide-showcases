/**
 * lit-html - Efficient HTML Templates
 *
 * Efficient HTML Templates
 * **POLYGLOT SHOWCASE**: One lit-html implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/lit-html (~300K+ downloads/week)
 *
 * Features:
 ...
 *
 * Package has ~300K+ downloads/week on npm - essential web component tool!
 */
...
if (import.meta.url.includes("elide-lit-html.ts")) {
  console.log("🎨 lit-html - Efficient HTML Templates for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same lit-html components work in:");
