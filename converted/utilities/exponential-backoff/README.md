# Exponential-backoff - Elide Polyglot Showcase
...
```typescript
import { Backoff, backoff } from './elide-exponential-backoff.ts';
...
```bash
elide run elide-exponential-backoff.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/exponential-backoff)
