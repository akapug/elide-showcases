 ...
 * Cherow
 *
 * Fast, spec-compliant JavaScript parser
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/cherow (~50K+ downloads/week)
 *
 * Features:
 * - High-performance ECMAScript parser
 ...
 *
 * Use cases:
 * - Speed-critical parsing, benchmarking tools
...
// CLI Demo
if (import.meta.url.includes("elide-cherow.ts")) {
  console.log("🌳 Cherow for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Cherow across languages:");
  console.log("  • JavaScript - Speed-critical parsing, benchmarking tools");
  ...
  console.log("- Speed-critical parsing, benchmarking tools");
