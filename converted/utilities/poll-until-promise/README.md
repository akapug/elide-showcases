# Poll-until-promise - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-poll-until-promise.ts';
...
```bash
elide run elide-poll-until-promise.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/poll-until-promise)
