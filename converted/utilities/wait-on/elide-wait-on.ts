 ...
 * Resource Waiting
 *
 * POLYGLOT SHOWCASE: One resource waiting for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need resource waiting
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share resource waiting across your stack
 *
...
const instance = new WaitOn();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("⏳ Resource Waiting for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same wait-on works in:");
  ...
  console.log("- One resource waiting for all languages");
