...
console.log("🏎️  uniq-by Performance Benchmark\n");
console.log("Testing Elide's polyglot uniq-by implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Deduplication (${ITERATIONS.toLocaleString()} iterations) ===\n`);
