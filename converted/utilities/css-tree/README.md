# CSS Tree - CSS Parser - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Fast and detailed CSS parser and generator with a single implementation that works across your entire polyglot stack.
...
- ✅ Fast and detailed CSS parser and generator
...
```typescript
import { parse, generate, traverse } from './elide-css-tree.ts';
...
parser = require('./elide-css-tree.ts')
...
```ruby
parser = Elide.require('./elide-css-tree.ts')
...
Value parser = context.eval("js", "require('./elide-css-tree.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide CSS Tree - CSS Parser (TypeScript)      │
│     elide-css-tree.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: CSS analyzers, optimizers, linters
...
- [npm package](https://www.npmjs.com/package/css-tree)
