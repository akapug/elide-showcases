 ...
 * Css Tree
 *
 * Fast detailed CSS parser and generator
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/css-tree (~1M+ downloads/week)
 *
 * Features:
 * - Complete CSS AST tooling
 ...
 *
 * Use cases:
 * - CSS analyzers, optimizers, linters
...
// CLI Demo
if (import.meta.url.includes("elide-css-tree.ts")) {
  console.log("🌳 Css Tree for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Css Tree across languages:");
  console.log("  • JavaScript - CSS analyzers, optimizers, linters");
  ...
  console.log("- CSS analyzers, optimizers, linters");
