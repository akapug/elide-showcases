/**
 * hybrids - Simple Web Components
 *
 * Simple Web Components
 * **POLYGLOT SHOWCASE**: One hybrids implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/hybrids (~10K+ downloads/week)
 *
 * Features:
 * - UI library based on plain objects
...
if (import.meta.url.includes("elide-hybrids.ts")) {
  console.log("🎨 hybrids - Simple Web Components for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same hybrids components work in:");
