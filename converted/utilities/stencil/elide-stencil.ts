 ...
 * **POLYGLOT SHOWCASE**: One stencil implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/stencil (~50K+ downloads/week)
 *
 * Features:
 * - Compiler for standards-based components
...
if (import.meta.url.includes("elide-stencil.ts")) {
  console.log("🎨 stencil - Web Component Compiler for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same stencil components work in:");
