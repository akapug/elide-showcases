 ...
 *
 * Based on https://www.npmjs.com/package/validate.js (~100K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): ValidateJs {
  return new ValidateJs(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Validate.js - Validation Library - Validation for Elide (POLYGLOT!)\n");
