...
export function createValidator(schema: ValidationSchema): Uniforms {
  return new Uniforms(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Uniforms - Universal Forms - Validation for Elide (POLYGLOT!)\n");
