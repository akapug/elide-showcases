 ...
 *
 * Based on https://www.npmjs.com/package/validatorjs (~100K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Validatorjs {
  return new Validatorjs(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ ValidatorJS - Validation Rules - Validation for Elide (POLYGLOT!)\n");
