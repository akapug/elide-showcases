/**
 * Pristine - Vanilla Validator
 *
 * Vanilla JS validation
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/pristine (~10K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): Pristine {
  return new Pristine(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Pristine - Vanilla Validator - Validation for Elide (POLYGLOT!)\n");
