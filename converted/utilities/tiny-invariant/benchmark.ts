/**
 * Performance Benchmark: tiny-invariant
 *
...
console.log("🏎️  tiny-invariant Performance Benchmark\n");
console.log("Testing Elide's polyglot tiny-invariant implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Error Handling (${ITERATIONS.toLocaleString()} iterations) ===\n`);
