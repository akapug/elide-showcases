 ...
 * Posthtml
 *
 * HTML transformer with plugins
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/posthtml (~500K+ downloads/week)
 *
 * Features:
 * - PostCSS-like HTML transformations
 ...
 *
 * Use cases:
 * - HTML build pipelines, templating
...
// CLI Demo
if (import.meta.url.includes("elide-posthtml.ts")) {
  console.log("🌳 Posthtml for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Posthtml across languages:");
  console.log("  • JavaScript - HTML build pipelines, templating");
  ...
  console.log("- HTML build pipelines, templating");
