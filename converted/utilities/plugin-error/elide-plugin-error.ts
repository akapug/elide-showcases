 ...
 * Error Handling
 *
 * POLYGLOT SHOWCASE: One error handling for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need error handling
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share error handling across your stack
 *
...
const instance = new PluginError();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Error Handling for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same plugin-error works in:");
  ...
  console.log("- One error handling for all languages");
