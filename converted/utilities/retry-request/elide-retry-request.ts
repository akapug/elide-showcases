...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔄 Retry request - HTTP Retry (POLYGLOT!)\n");
  ...
  setTimeout(() => {
    ...
    console.log("🌐 Same retry-request works in:");
