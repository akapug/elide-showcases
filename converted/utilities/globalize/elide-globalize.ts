/**
 * globalize - Internationalization Library
 * Based on https://www.npmjs.com/package/globalize (~100K+ downloads/week)
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🌍 globalize - i18n Library for Elide (POLYGLOT!)\n");
