 ...
 *
 * Based on https://www.npmjs.com/package/input-validator (~10K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): InputValidator {
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Input Validator - Validation for Elide (POLYGLOT!)\n");
