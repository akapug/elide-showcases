 ...
 * **POLYGLOT SHOWCASE**: One rollup-plugin-node-resolve for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/@rollup/plugin-node-resolve (~10M+ downloads/week)
 *
 * Features:
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java need resolver too
 * - ONE rollup-plugin-node-resolve works everywhere on Elide
 ...
 *
 * Package has ~10M+ downloads/week on npm - essential build tool!
 */
...
/**
 * Main rollup-plugin-node-resolve function
 */
...
if (import.meta.url.includes("elide-rollup-plugin-node-resolve.ts")) {
  console.log("🔧 Resolver for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same rollup-plugin-node-resolve logic works in:");
  ...
  console.log("  ✓ One rollup-plugin-node-resolve, all languages");
