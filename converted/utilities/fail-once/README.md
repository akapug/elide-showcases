# Fail-once - Elide Polyglot Showcase
...
```typescript
import { pWhilst, pTimes, until, poll } from './elide-fail-once.ts';
...
```bash
elide run elide-fail-once.ts
```

## Links

- [Original npm package](https://www.npmjs.com/package/fail-once)
