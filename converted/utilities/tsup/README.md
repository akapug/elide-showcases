...
# Run this conversion
cd converted/utilities/tsup
elide run elide-tsup.ts
```

## Usage

See `elide-tsup.ts` for implementation examples.
...
- Downloads: 3.0M/week
- Repository: https://www.npmjs.com/package/tsup
