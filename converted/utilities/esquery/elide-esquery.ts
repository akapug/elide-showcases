 ...
 *
 * Based on https://www.npmjs.com/package/esquery (~2M+ downloads/week)
 *
 * Features:
 * - jQuery-style AST queries
 ...
 *
 * Use cases:
 * - Find patterns, complex AST searches
...
// CLI Demo
if (import.meta.url.includes("elide-esquery.ts")) {
  console.log("🌳 Esquery for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Esquery across languages:");
  console.log("  • JavaScript - Find patterns, complex AST searches");
  ...
  console.log("- Find patterns, complex AST searches");
