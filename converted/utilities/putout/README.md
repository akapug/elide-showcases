# Putout - Pluggable Transformer - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Modern code transformer and linter with a single implementation that works across your entire polyglot stack.
...
- ✅ Modern code transformer and linter
...
```typescript
import { parse, generate, traverse } from './elide-putout.ts';
...
parser = require('./elide-putout.ts')
...
```ruby
parser = Elide.require('./elide-putout.ts')
...
Value parser = context.eval("js", "require('./elide-putout.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide Putout - Pluggable Transformer (TypeScript)      │
│     elide-putout.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Code modernization, auto-fixing lint rules
...
- [npm package](https://www.npmjs.com/package/putout)
