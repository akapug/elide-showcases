 ...
 *
 * Based on https://www.npmjs.com/package/putout (~50K+ downloads/week)
 *
 * Features:
 ...
 *
 * Use cases:
 * - Code modernization, auto-fixing linters
...
// CLI Demo
if (import.meta.url.includes("elide-putout.ts")) {
  console.log("🌳 Putout for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Putout across languages:");
  console.log("  • JavaScript - Code modernization, auto-fixing linters");
  ...
  console.log("- Code modernization, auto-fixing linters");
