 ...
 * Jscodeshift
 *
 * Codemod toolkit for JavaScript
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/jscodeshift (~500K+ downloads/week)
 *
 * Features:
 * - Facebook's codemod runner
 ...
 *
 * Use cases:
 * - Large-scale refactoring, API migrations
...
// CLI Demo
if (import.meta.url.includes("elide-jscodeshift.ts")) {
  console.log("🌳 Jscodeshift for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Jscodeshift across languages:");
  console.log("  • JavaScript - Large-scale refactoring, API migrations");
  ...
  console.log("- Large-scale refactoring, API migrations");
