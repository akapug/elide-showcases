 ...
 * Queue Library
 *
 * POLYGLOT SHOWCASE: One queue library for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need queue library
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share queue library across your stack
 *
...
const instance = new BetterQueue();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Queue Library for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same better-queue works in:");
  ...
  console.log("- One queue library for all languages");
