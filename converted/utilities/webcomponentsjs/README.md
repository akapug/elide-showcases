...
Based on [npm:webcomponentsjs](https://www.npmjs.com/package/webcomponentsjs) (~200K+ downloads/week)
...
```typescript
import { defineComponent, html, css } from './elide-webcomponentsjs.ts';
