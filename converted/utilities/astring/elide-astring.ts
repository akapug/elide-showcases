 ...
 * Astring
 *
 * Tiny and fast JavaScript code generator
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/astring (~1M+ downloads/week)
 *
 * Features:
 * - Lightweight AST-to-code generator
 ...
 *
 * Use cases:
 * - Bundle optimization, fast code generation
...
// CLI Demo
if (import.meta.url.includes("elide-astring.ts")) {
  console.log("🌳 Astring for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Astring across languages:");
  console.log("  • JavaScript - Bundle optimization, fast code generation");
  ...
  console.log("- Bundle optimization, fast code generation");
