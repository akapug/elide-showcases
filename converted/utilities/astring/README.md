# Astring - Tiny Code Generator - Elide Polyglot Showcase

> **One AST/parser implementation for ALL languages** - TypeScript, Python, Ruby, and Java

Lightweight and fast JavaScript code generator with a single implementation that works across your entire polyglot stack.
...
- ✅ Lightweight and fast JavaScript code generator
...
```typescript
import { parse, generate, traverse } from './elide-astring.ts';
...
parser = require('./elide-astring.ts')
...
```ruby
parser = Elide.require('./elide-astring.ts')
...
Value parser = context.eval("js", "require('./elide-astring.ts')");
...
```
┌─────────────────────────────────────┐
│     Elide Astring - Tiny Code Generator (TypeScript)      │
│     elide-astring.ts                  │
└─────────────────────────────────────┘
         ↓           ↓           ↓
    ┌────────┐  ┌────────┐  ┌────────┐
...
- **Use case**: Bundle optimization, fast code generation
...
- [npm package](https://www.npmjs.com/package/astring)
