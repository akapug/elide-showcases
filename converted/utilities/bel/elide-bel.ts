/**
 * bel - Template Strings
 *
 * Template Strings
 * **POLYGLOT SHOWCASE**: One bel implementation for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/bel (~20K+ downloads/week)
 *
 * Features:
 * - Simple template string to DOM
...
if (import.meta.url.includes("elide-bel.ts")) {
  console.log("🎨 bel - Template Strings for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same bel components work in:");
