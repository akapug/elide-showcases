/**
 * make-plural - Internationalization Library
 * Based on https://www.npmjs.com/package/make-plural (~300K+ downloads/week)
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🌍 make-plural - i18n Library for Elide (POLYGLOT!)\n");
