 ...
 *
 * Based on https://www.npmjs.com/package/just-validate (~30K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): JustValidate {
  return new JustValidate(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Just Validate - Form Validation - Validation for Elide (POLYGLOT!)\n");
