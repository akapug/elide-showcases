 ...
 *
 * Based on https://www.npmjs.com/package/convict (~200K+ downloads/week)
 *
 * Features:
...
export function convict(input: any): any {
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 convict - Configuration Validation (POLYGLOT!)\n");
