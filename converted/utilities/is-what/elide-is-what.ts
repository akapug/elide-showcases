/**
 * is-what - Type Checkers
 *
 * Simple type checking
 * **POLYGLOT SHOWCASE**: One validation library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/is-what (~100K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): IsWhat {
  return new IsWhat(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ is-what - Type Checkers - Validation for Elide (POLYGLOT!)\n");
