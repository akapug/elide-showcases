 ...
 * Build Tool
 *
 * POLYGLOT SHOWCASE: One build tool for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need build tool
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share build tool across your stack
 *
...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  console.log("🌐 Same jake works in:");
  ...
  console.log("- One build tool for all languages");
