...
export function createValidator(schema: ValidationSchema): Autoform {
  return new Autoform(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ AutoForm - Automatic Forms - Validation for Elide (POLYGLOT!)\n");
