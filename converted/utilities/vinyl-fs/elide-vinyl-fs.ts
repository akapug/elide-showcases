 ...
 * Virtual File System
 *
 * POLYGLOT SHOWCASE: One virtual file system for ALL languages on Elide!
 *
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java all need virtual file system
 * - ONE implementation works everywhere on Elide
 * - Consistent API across languages
 * - Share virtual file system across your stack
 *
...
const instance = new VinylFs();
export default instance;

// CLI Demo
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("🔧 Virtual File System for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same vinyl-fs works in:");
  ...
  console.log("- One virtual file system for all languages");
