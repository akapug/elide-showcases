 ...
 * Sourcemap Codec
 *
 * Encode/decode source map mappings
 * **POLYGLOT SHOWCASE**: One AST/parser library for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/sourcemap-codec (~2M+ downloads/week)
 *
 * Features:
 * - Fast sourcemap codec
...
// CLI Demo
if (import.meta.url.includes("elide-sourcemap-codec.ts")) {
  console.log("🌳 Sourcemap Codec for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Sourcemap Codec across languages:");
  console.log("  • JavaScript - Build tools, bundlers, transpilers");
  ...
  console.log("- Build tools, bundlers, transpilers");
