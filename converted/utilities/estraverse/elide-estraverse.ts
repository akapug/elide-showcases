 ...
 *
 * Based on https://www.npmjs.com/package/estraverse (~10M+ downloads/week)
 *
 * Features:
 * - Powerful AST traversing
 ...
 *
 * Use cases:
 * - Complex transformations, scope analysis
...
// CLI Demo
if (import.meta.url.includes("elide-estraverse.ts")) {
  console.log("🌳 Estraverse for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Use Estraverse across languages:");
  console.log("  • JavaScript - Complex transformations, scope analysis");
  ...
  console.log("- Complex transformations, scope analysis");
