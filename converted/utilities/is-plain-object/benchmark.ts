/**
 * Performance Benchmark: IsPlainObject
 *
...
import { default as elideIsPlainObject } from './elide-is-plain-object.ts';

console.log("🏎️  IsPlainObject Benchmark\n");
console.log("Testing Elide's polyglot object checking performance\n");
...
const batchResults = batchItems.map(item => elideIsPlainObject(item));
...
console.log(`  • Service processing 1M object checking operations/day`);
...
console.log("=== Summary ===\n");
console.log("Elide IsPlainObject implementation:");
