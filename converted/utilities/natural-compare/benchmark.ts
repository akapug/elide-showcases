/**
 * Performance Benchmark: natural-compare
 *
...
console.log("🏎️  natural-compare Performance Benchmark\n");
console.log("Testing Elide's polyglot natural-compare implementation\n");

const ITERATIONS = 100_000;

console.log(`=== Benchmark: Sorting (${ITERATIONS.toLocaleString()} iterations) ===\n`);
