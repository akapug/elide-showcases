 ...
 * **POLYGLOT SHOWCASE**: One rollup-plugin-commonjs for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/@rollup/plugin-commonjs (~10M+ downloads/week)
 *
 * Features:
 ...
 *
 * Polyglot Benefits:
 * - Python, Ruby, Java need commonjs plugin too
 * - ONE rollup-plugin-commonjs works everywhere on Elide
...
/**
 * Main rollup-plugin-commonjs function
 */
...
if (import.meta.url.includes("elide-rollup-plugin-commonjs.ts")) {
  console.log("🔧 CommonJS Plugin for Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same rollup-plugin-commonjs logic works in:");
  ...
  console.log("  ✓ One rollup-plugin-commonjs, all languages");
