 ...
 *
 * Based on https://www.npmjs.com/package/form-serialize (~100K+ downloads/week)
 *
 * Features:
...
export function createValidator(schema: ValidationSchema): FormSerialize {
  return new FormSerialize(schema);
}
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("✅ Form Serialize - Validation for Elide (POLYGLOT!)\n");
