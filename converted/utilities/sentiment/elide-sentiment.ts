 ...
 *
 * Based on https://www.npmjs.com/package/sentiment (~100K+ downloads/week)
 *
 * Features:
...
export function process(input: any): any {
  console.log("Processing with sentiment...");
...
if (import.meta.url === `file://${process.argv[1]}`) {
  console.log("Sentiment - Sentiment Analysis - Elide (POLYGLOT!)\n");
  ...
  console.log("🌐 Same sentiment works in:");
