 ...
 * **POLYGLOT SHOWCASE**: One parcel for ALL languages on Elide!
 *
 * Based on https://www.npmjs.com/package/parcel-bundler (~3M+ downloads/week)
 *
 * Features:
 ...
 * - ONE parcel works everywhere on Elide
...
if (import.meta.url.includes("elide-parcel.ts")) {
  ...
  console.log("🌐 Same parcel logic works in:");
  ...
  console.log("  ✓ One parcel, all languages");
